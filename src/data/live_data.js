...
export const lastUpdated = "2026-05-20";
...
export const todayV2Picks = [
  {
    ...
    "contextReasoning": [
      ...
      "vs CWS prior: H avg 5.0 > line (+15)",
      "Moderate model edge 0.93 (+10)",
      "Tier PREMIUM (+10)"
    ],
    "highConviction": true,
    "trailingRate": {
  ...
  },
  {
    ...
    "riskNotes": [],
    "lineupSurprise": 0.0,
    "lineupBatterKRate": 0.24960634296916603,
    "bestPrice": -150.0,
    "bestBook": "Fanatics",
    "keyFactors": [
      {
    ...
    "contextReasoning": [
      ...
      "vs SEA prior: K avg 4.0 < line 5.5 (+20)"
    ],
    "trailingRate": {
      "rate": 0.75,
      "adjusted_rate": 0.681,
      "lineup_adjustment_pp": -6.9,
      "opp_k_rate": 0.244,
      "n_used": 8,
      "n_total": 9,
      "over_count": 2,
  ...
  },
  {
    ...
    "speculative": false,
    "riskNotes": [],
    "lineupSurprise": -0.010518693567975718,
    "lineupBatterKRate": 0.22098765432098763,
    "bestPrice": -137.0,
    "bestBook": "DraftKings",
    "keyFactors": [
      {
    ...
    "contextReasoning": [
      ...
      "Ump Ryan Additon (low-K zone, kF=0.90) (+10) [capped]",
      "Lineup: below-norm lineup today (avg OPS 0.628, PHI season 0.692) (-5) [capped]",
      "Career vs today's 9 bats (53 PA): K% 13.2% vs lg 22.0% (+15) [capped]",
      "Sprint signal stack capped: raw=+23 → applied +15 (4 signals correlated)"
    ],
    "trailingRate": {
      "rate": 0.75,
      "adjusted_rate": 0.737,
      "lineup_adjustment_pp": -1.3,
      "opp_k_rate": 0.225,
      "n_used": 8,
      "n_total": 10,
      "over_count": 2,
  ...
  },
  {
    ...
    "speculative": true,
    "riskNotes": [],
    "lineupSurprise": 0.026382782214660033,
    "lineupBatterKRate": 0.25537037037037036,
    "bestPrice": -148.0,
    "bestBook": "DraftKings",
    "keyFactors": [
      {
    ...
    "contextReasoning": [
      ...
      "Today's lineup more K-prone than team norm (+2.6pp K-rate) (+4)"
    ],
    "trailingRate": {
      "rate": 0.5,
      "adjusted_rate": 0.524,
      "lineup_adjustment_pp": 2.4,
      "opp_k_rate": 0.229,
      "n_used": 8,
      "n_total": 9,
      "over_count": 4,
  ...
  },
  {
    ...
    "lineupSurprise": 0.02926921134741467,
    "lineupBatterKRate": 0.22709876543209873,
    "bestPrice": -108.0,
    "bestBook": "betPARX",
    "keyFactors": [
      {
    ...
    "contextReasoning": [
      ...
      "Today's lineup more K-prone than team norm (+2.9pp K-rate) (-4)",
      "Weather: hot (86°F) (+5)",
      "Ump Stu Scheurwater (low-K zone, kF=0.96) (+5)"
    ],
    "trailingRate": {
      "rate": 0.5,
      "adjusted_rate": 0.581,
      "lineup_adjustment_pp": 8.1,
      "opp_k_rate": 0.194,
      "n_used": 8,
      "n_total": 9,
      "over_count": 4,
  ...
  },
  {
    ...
    "riskNotes": [],
    "lineupSurprise": 0.0,
    "lineupBatterKRate": 0.20338951942974584,
    "bestPrice": -128.0,
    "bestBook": "DraftKings",
    "keyFactors": [
      {
  ...
  },
  {
    ...
    "speculative": false,
    "riskNotes": [],
    "lineupSurprise": -0.016491218160870014,
    "lineupBatterKRate": 0.22805555555555557,
    "bestPrice": -138.0,
    "bestBook": "FanDuel",
    "keyFactors": [
      {
    ...
    "batters": [],
    "publishTime": "2026-05-20T11:44:31",
  ...
  },
  {
    ...
    "riskNotes": [],
    "lineupSurprise": 0.0,
    "lineupBatterKRate": 0.2488884562852271,
    "bestPrice": 128.0,
    "bestBook": "FanDuel",
    "keyFactors": [
      {
    ...
    "batters": [],
    "publishTime": "2026-05-20T11:44:32",
    "publishStage": "afternoon"
  },
  {
    "id": 39,
  ...
  },
  {
    ...
    "edge": 0.5967,
    "abAgree": false,
    "confidenceScore": 0.597,
    "hcFlag": false,
    "speculative": true,
    "riskNotes": [],
    "lineupSurprise": 0.0,
    "lineupBatterKRate": 0.19820204230437774,
    "bestPrice": -130.0,
    "bestBook": "FanDuel",
    "keyFactors": [
      {
  ...
  },
  {
    ...
    "riskNotes": [],
    "lineupSurprise": 0.0,
    "lineupBatterKRate": 0.21564427921020327,
    "bestPrice": -118.0,
    "bestBook": "BetMGM",
    "keyFactors": [
      {
    ...
    "promoters": [
      {
        ...
        "detail": "Career K% 37% at line 4.5 — power arm on a modest line is structurally favored to go over."
      }
    ],
    "promoterBoost": 0.15,
    "publishTime": "2026-05-20T11:44:32",
  ...
  },
  {
    ...
    "riskNotes": [],
    "lineupSurprise": 0.0,
    "lineupBatterKRate": 0.20930143427673706,
    "bestPrice": -147.0,
    "bestBook": "DraftKings",
    "keyFactors": [
      {
...
export const todayFilteredOut = [
  {
    ...
    "modelPred": 4.28,
    "edge": 3.22,
    "confidenceScore": 2.041,
    "tier": "ELITE",
    "rejectionReasons": [
      {
        "label": "Durable pitcher + Ks Under",
        "detail": "Chris Sale has a 89% Quality Start rate this season (9 starts). Durable pitchers go deep, face more batters, and produce more strikeouts — Under busts 47.9% vs 56.2% for less durable arms (-8.3pp, n=261 in backtest)."
      },
      {
        "label": "Loser-pitcher warning",
        "detail": "Chris Sale is on our loser list (>=3 picks, ROI < -20% historically). Surfaced for operator awareness — NOT filtered out. Re-validate over 30-day rolling window."
      },
      {
        "label": "Durable pitcher + Ks Under",
        "detail": "Chris Sale has a 89% Quality Start rate this season (9 starts). Durable pitchers go deep, face more batters, and produce more strikeouts — Under busts 47.9% vs 56.2% for less durable arms (-8.3pp, n=261 in backtest)."
  ...
  },
  {
    ...
    "rejectionReasons": [
      {
        "label": "Volatile walks history",
        "detail": "Tanner Bibee walked 3+ batters in ≥25% of his recent starts. Unders on his walks bust too often to trust."
      },
      {
        "label": "BB archetype: AVERAGE_BB",
        "detail": "Historical BB% puts this pitcher in a profile where Under walks lines have negative expected value."
...
export const todayMetaOnlyPicks = [
  ...
  },
  {
    ...
    "contextReasoning": [
      ...
      "Opp K-rate 24.4% > lg+2pp (high-K = fewer hits) (+10)",
      "Weather: humid (90%) (+3)"
    ],
  ...
  },
  {
    ...
    "contextReasoning": [
      "L6 K avg 4.8 >= line 4.5 (-10)",
      "Opp K-rate 24.8% > lg+2.5pp (high-K offense) (-15)"
    ],
    "drVetoed": true,
  ...
  },
  {
    ...
    "contextReasoning": [
      "L6 H avg 5.3 > line (+10)",
      "vs SEA prior: H avg 6.0 > line (+15)",
  ...
  },
  {
    ...
    "contextReasoning": [
      ...
      "Weather: hot (86°F), dry (22%), wind OUT 11mph (-9)"
    ],
    "paperWatch": true,
    "overrideTriggers": "same-pitcher-cap",
    "samePitcherCapDropped": true,
  ...
  },
  {
    ...
    "speculative": true,
    "riskNotes": [],
    "lineupSurprise": 0.057986484598269494,
    "lineupBatterKRate": 0.28645502645502646,
    "bestPrice": -115.0,
    "bestBook": "FanDuel",
    "keyFactors": [
      {
    ...
    "contextRawScore": -15,
    "contextReasoning": [
      "Today's lineup more K-prone than team norm (+5.8pp K-rate) (+6)",
      "Weather: dry (34%) (-3)",
      "Ump Ryan Additon (low-K zone, kF=0.90) (-10)",
  ...
  },
  {
    ...
    "contextRawScore": 5,
    "contextReasoning": [
      "L6 H avg 4.0 < line (+10)",
      "Opp K-rate 25.1% > lg+2pp (high-K = fewer hits) (+10)",
  ...
  },
  {
    ...
    "contextReasoning": [
      ...
      "Tier PREMIUM (+10)",
      "Weather: hot (86°F), dry (22%), wind OUT 11mph (+10)"
    ],
    "trailingRate": {
      "rate": 0.25,
      "adjusted_rate": 0.25,
      ...
      "market": "H",
      "ok": false,
      "reason": "only 2/8 over (25%) — model edge contradicted",
      "verdict": "RED"
    },
    "paperWatch": true,
  ...
  },
  {
    ...
    "riskNotes": [],
    "lineupSurprise": 0.0,
    "lineupBatterKRate": 0.19996368015751778,
    "bestPrice": -165.0,
    "bestBook": "DraftKings",
    "keyFactors": [
      {
    ...
    "contextReasoning": [
      ...
      "Opp K-rate 19.7% < lg-1.5pp (low-K offense) (+15)",
      "Weather: hot (94°F), dry (7%) (+8)"
    ],
    "trailingRate": {
      "rate": 0.25,
      "adjusted_rate": 0.323,
      "lineup_adjustment_pp": 7.3,
      "opp_k_rate": 0.197,
      "n_used": 8,
      "n_total": 9,
      "over_count": 6,
      ...
      "market": "K",
      "ok": false,
      "reason": "only 2/8 under (25%) → adj 32% after opp-K — model edge contradicted",
      "verdict": "RED"
    },
    "paperWatch": true,
  ...
  },
  {
    ...
    "edge": 1.4949,
    "abAgree": true,
    "confidenceScore": 1.085,
    "hcFlag": true,
    "speculative": false,
    "riskNotes": [],
    "lineupSurprise": 0.0,
    "lineupBatterKRate": 0.24454677371642558,
    "bestPrice": 100.0,
    "bestBook": "BetMGM",
    "keyFactors": [
      {
    ...
    "trailingRate": {
      ...
      "market": "K",
      "ok": false,
      "reason": "only 4/8 under (50%) → adj 43% after opp-K — model edge contradicted",
      "verdict": "RED"
    },
    "paperWatch": true,
