...
export const lastUpdated = "2026-05-03";
...
export const todayV2Picks = [
  {
    ...
    "speculative": false,
    "riskNotes": [],
    "lineupSurprise": 0.027786381479908556,
    "lineupBatterKRate": 0.22561728395061728,
    "bestPrice": -151.0,
    "bestBook": "DraftKings",
    "keyFactors": [
      {
  ...
  },
  {
    ...
    "speculative": true,
    "riskNotes": [],
    "lineupSurprise": 0.03520378830250384,
    "lineupBatterKRate": 0.23171604938271603,
    "bestPrice": -152.0,
    "bestBook": "FanDuel",
    "keyFactors": [
      {
  ...
  },
  {
    ...
    "edge": 1.59,
    "abAgree": true,
    "confidenceScore": 1.109,
    "hcFlag": true,
    "speculative": false,
    "riskNotes": [],
    "lineupSurprise": 0.0,
    "lineupBatterKRate": 0.19332660472776947,
    "bestPrice": -140.0,
    "bestBook": "BetMGM",
    "keyFactors": [
      {
...
export const todayFilteredOut = [
  {
    ...
    "modelPred": 3.96,
    "edge": 1.54,
    "confidenceScore": 1.02,
    "tier": "ELITE",
    "rejectionReasons": [
      {
        "label": "Durable pitcher + Ks Under",
        "detail": "Parker Messick has a 50% Quality Start rate this season (6 starts). Durable pitchers go deep, face more batters, and produce more strikeouts — Under busts 47.9% vs 56.2% for less durable arms (-8.3pp, n=261 in backtest)."
      }
    ]
  },
  {
    ...
    "rejectionReasons": [
      ...
      },
      {
        ...
        "detail": "Merrill Kelly activated from IL 19 days ago. Backtest: walks Unders in this recency bucket hit 60.0% vs 64.9% baseline (-4.9pp). Command tends to lag after IL stints."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "rejectionReasons": [
      {
        "label": "Volatile walks history",
        "detail": "Kris Bubic walked 3+ batters in ≥25% of his recent starts. Unders on his walks bust too often to trust."
      },
      {
        "label": "Walks confidence gate",
        "detail": "Model confidence 0.59 is below our walks-only threshold of 0.60 (locked 2026-04-19 after backtest showed structural walks underperformance below this line)."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "rejectionReasons": [
      ...
      },
      {
        ...
        "detail": "Chase Burns activated from IL 234 days ago. Backtest: walks Unders in this recency bucket hit 59.5% vs 64.9% baseline (-5.4pp). Command tends to lag after IL stints."
      }
    ]
  },
  {
...
export const todayArchetypeWatchlist = [
  ...
  },
  {
    ...
    "marketShort": "K",
    "consensusLine": 6.5,
    "modelPred": 5.609574794769287,
    "signal": "career K% 36%",
    "reason": "career K% 36% on K line 6.5. Model predicts 5.6 (under by 0.89) but archetype profile favors over. Common reason for disagreement: post-injury ramp-up, short recent outings, or role-change. Review manually."
  },
  {
    "pitcherName": "Braxton Ashcraft",
    "pitcherTeam": "PIT",
  ...
  },
  {
    ...
    "marketShort": "K",
    "consensusLine": 6.5,
    "modelPred": 5.204687118530273,
    "signal": "HIGH_K_ARMS list",
    "reason": "HIGH_K_ARMS list on K line 6.5. Model predicts 5.2 (under by 1.30) but archetype profile favors over. Common reason for disagreement: post-injury ramp-up, short recent outings, or role-change. Review manually."
  },
  {
    "pitcherName": "Jesús Luzardo",
    "pitcherTeam": "PHI",
