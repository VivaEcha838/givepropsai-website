  ...
  return (
    <section id="results" className="py-20 relative">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 2026-05-27: Sharp Plays callout removed. Analysis showed the
            `conf ≥ 0.65` Sharp filter only added +0.5pp WR over the
            unfiltered post-4/20 baseline (66.9% vs 67.4%), and tighter
            thresholds (0.70/0.75/0.80) all underperformed unfiltered.
            The 67.9% all-time Sharp WR was an artifact of 30 pre-4/20
            picks (73% WR) that flattered the average. In the modern era
            every pick is essentially Sharp-quality, so the badge was
            misleading. See _analyze_sharp_thresholds.py output. */}
