...
const audiences = [
  {
    ...
    label: "Analysts",
    icon: ChartBarIcon,
    headline: "Data-Driven Pitcher Prop Analysis",
    sub: `Three ML models covering Strikeouts, Walks, and Hits Allowed with ${(COMBINED.winRate * 100).toFixed(1)}% backtested win rate identifying potentially mispriced lines across ${COMBINED.totalPredictions.toLocaleString()} out-of-sample predictions validated against real sportsbook lines. All models statistically significant in backtesting. Past performance does not guarantee future results.`,
  },
  {
    key: "sportsbooks",
    label: "Sportsbooks",
    icon: BuildingOffice2Icon,
    headline: "Evaluate Your Lines",
    sub: "Quantile-regression probabilities identify potentially mispriced K, BB, and Hits Allowed props based on backtested models. Evaluate your hold with our API feed. Past performance does not guarantee future results.",
  },
  {
    key: "data",
    label: "Data Partners",
